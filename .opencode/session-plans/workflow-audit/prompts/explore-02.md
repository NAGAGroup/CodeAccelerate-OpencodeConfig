...
# Node: explore-02 — Debug Workflow Audit

**Open question this node covers:** What improvements and bugs exist in the Debug planning workflow?
...
- `.opencode/commands/plan-debug.md`
...
Update `spec.md` under **Findings** as conclusions are reached. Label each finding clearly (e.g., "Debug — hypothesis-form.md: ...").
...
- To continue exploring this question: `next_step({ next: "explore-02" })`
- When the Debug workflow audit is sufficiently complete: `next_step({ next: "explore-03" })`
