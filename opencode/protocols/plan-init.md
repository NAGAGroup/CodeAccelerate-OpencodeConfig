...
Phase 1 runs at the start of every planning session, regardless of session type.

## Step 1 — Project Layout

Run a quick glob/grep to get project layout: file tree of key directories (`opencode/agents/`, `opencode/protocols/`, `opencode/commands/`, `opencode/skills/`, `.opencode/sessions/`, `.opencode/agents/`), and any obvious entry points.
