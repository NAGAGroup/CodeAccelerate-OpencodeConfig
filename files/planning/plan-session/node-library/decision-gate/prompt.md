...
**Constraints:** Base your choice on evidence from prior nodes documented in planning notes, with priority given to evidence over assumptions. The DAG structure defines the available branches. Retrieve planning notes about the branch conditions if they were stored during planning.
