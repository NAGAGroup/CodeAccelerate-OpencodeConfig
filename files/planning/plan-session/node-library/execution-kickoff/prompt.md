...
<check>
1. Do I understand the full plan shape — all phases, branches, and terminal paths?
2. Have I retrieved enough planning context to understand why the plan is structured this way?
3. Are my orientation notes useful to later nodes — do they capture the execution strategy clearly?
</check>
