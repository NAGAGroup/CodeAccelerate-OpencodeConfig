**Plan Name:** {{PLAN_NAME}}
**Required Skills:** delegating-to-external-scout, asking-questions
...
1. Use the `delegating-to-external-scout` skill to compose a research query — think through what external information is needed and what scope protects proprietary information
