...
<instructions>
1. Load the tailwrench skill. Use it to compose a dispatch prompt — think through what commands need to run, in what order, what preconditions must be satisfied, and what success looks like.
