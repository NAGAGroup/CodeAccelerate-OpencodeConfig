...
<goal>
Have a focused conversation with the user mid-execution to gather input or present findings before proceeding.
</goal>
...
<check>
1. What do I need from the user — information, a decision, or their perspective on findings?
2. Have I provided enough context for them to engage meaningfully without re-reading the whole session?
3. Should I store any decisions or clarifications the user provides to qdrant for future nodes?
</check>
