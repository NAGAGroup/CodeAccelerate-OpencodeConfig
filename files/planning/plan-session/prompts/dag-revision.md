...
2. Load the dag-reviser skill. Use it to compose a dispatch prompt.
3. Dispatch dag-reviser using the task tool with plan name {{PLAN_NAME}} and the finalized plan document in full. Do not provide any review findings or planning context in this prompt — the reviser will retrieve all necessary context from qdrant.
4. Call next_step.
</instructions>
