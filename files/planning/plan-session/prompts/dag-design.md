**Plan Name:** {{PLAN_NAME}}
**Required Skills:** delegating-to-dag-designer
...
2. Use the `delegating-to-dag-designer` skill to compose a dispatch prompt — think through what the DAG should accomplish structurally: what phases of work are needed, what decision points exist, what could fail and need a retry path
